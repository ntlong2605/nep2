...
package com.gcox.wallet.scrypt.crypto;
...
import static com.gcox.wallet.scrypt.codec.Base64.decode;
import static com.gcox.wallet.scrypt.codec.Base64.encode;
...
public class SCryptUtil {
    ...
    public static byte[] scrypt(String passwd, byte[] salt, int N, int r, int p) {
        try {
            return SCrypt.scrypt(passwd.getBytes("UTF-8"), salt, N, r, p, 64);
